...
public class CameraActivity extends Activity {
    ...
    public static final int MODE_SHOW_CROP = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mode = getIntent().getIntExtra(KEY_MODE, MODE_TAKE_PHOTO);
        if (mode == MODE_SHOW_CROP) {
            cropView.setFilePath(getIntent().getStringExtra(KEY_OUTPUT_FILE_PATH));
            showCrop();
        }
    }
